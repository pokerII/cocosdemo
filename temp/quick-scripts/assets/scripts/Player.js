...
cc._RF.push(module, '71a13/yBJVDVKrE5szQMddY', 'Player', __filename);
// scripts/Player.js
...
cc.Class({
    ...
    setJumpAction: function setJumpAction() {
        ...
        var jumpDowm = cc.moveBy(this.jumpDuration, cc.p(0, -this.jumpHeight)).easing(cc.easeCubicActionIn());
        var callback = cc.callFunc(this.playJumpSound, this);
        return cc.repeatForever(cc.sequence(jumpUp, jumpDowm, callback));
    },
